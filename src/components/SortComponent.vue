  ...
  <div class="relative mb-5">
    ...
    <div class="flex justify-center gap-3 items-center">
      ...
      <button
        ...
        class="btn bg-gray-700 text-white px-3 py-1 rounded hover:bg-blue-600 absolute left-2 flex items-center gap-1"
      >
      ...
      <button
        @click="mostrarOrdens"
        class="btn bg-green-700 text-white px-3 py-1 rounded hover:bg-blue-600 absolute right-2 flex items-center gap-1"
      >
